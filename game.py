...
class SnakeGame:
    ...
    def show_game_over(self):
        ...
        play_again_text = pygame.font.Font(None, 36).render("Play", True, WHITE)
        exit_text = pygame.font.Font(None, 36).render("Exit", True, WHITE)
        ...
        self.screen.blit(play_again_text, (150, 300))
        self.screen.blit(exit_text, (250, 300))
        ...
        while True:
            ...
            play_again_hover = 150 + 100 > mouse[0] > 150 and 300 + 50 > mouse[1] > 300
            exit_hover = 250 + 100 > mouse[0] > 250 and 300 + 50 > mouse[1] > 300
