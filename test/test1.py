...
class SnakeGame:
    ...
    def check_collision(self):
        if self.snake.body[0] in self.snake.body[1:]:
            return True
        if self.snake.body[0][0] < 0 or self.snake.body[0][0] >= GRID_WIDTH or self.snake.body[0][1] < 0 or self.snake.body[0][1] >= GRID_HEIGHT:
            return True
        return False
    ...
    def run(self):
        while not self.game_over:
            ...
            self.clock.tick(10)  # Adjust the game speed here
